//------------------------------------------------------------------------------
// <copyright file="ChangeBrowserControlCommand.cs" company="Company">
...
namespace VSGerrit.Features.ChangeBrowser
{
    ...
    internal sealed class ChangeBrowserControlCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("d2c891e6-7462-487f-945b-96448b6902a4");
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = this.package.FindToolWindow(typeof(ChangeBrowserToolWindow), 0, true);
